...
namespace ServerCore
{
    public class Settings
    {
        ...
        public const String VERSION = "ServerX v1.2 ";
        ...
        public static String Topic
        {
            get
            {
                ...
                if (topic.Length < 2)
                {
                    topic = "Welcome to my new Channel";
                    Set("topic", topic);
                }
        ...
        public static T Get<T>(String name, params String[] subkeys)
        {
            ...
            RegistryKey key = Registry.CurrentUser.OpenSubKey("Software\\ServerX\\");

            if (key == null)
            {
                Registry.CurrentUser.CreateSubKey("Software\\ServerX\\");
                key = Registry.CurrentUser.OpenSubKey("Software\\ServerX\\");
            }
        ...
        public static bool Set(String name, object value, params String[] subkeys)
        {
            ...
            RegistryKey key = Registry.CurrentUser.OpenSubKey("Software\\ServerX\\", true);

            if (key == null)
            {
                Registry.CurrentUser.CreateSubKey("Software\\ServerX\\");
                key = Registry.CurrentUser.OpenSubKey("Software\\ServerX\\", true);
            }
